    ...
    <body class="pos-r">
                        ...
                        <tbody>
                            <?php foreach ($video as $key => $v): ?>
                                ...
                                <tr class="text-c va-m">
                                    ...
                                    <td><?=$v['id']?></td>
                                    <td><a onClick="product_show('<?=$v['topic']?>', 'show', '<?=$v['id']?>')" href="javascript:;">
                                        <img width="60" class="product-thumb" src="<?=$v['pic']?>"></a></td>
                                            <td class="text-l"><?=$v['topic']?></td>
                                            <td class="text-l"><?=$v['introduce']?></td>
                                            <td><?php echo $v->column->name ?></td>
                                            ...
                                            <td class="td-manage">
                                                ...
                                                <a style="text-decoration:none" class="ml-5" onClick="product_add('<?=$v['topic']?>', 'addvideo', '<?=$v['id']?>')" href="javascript:;" title="添加视频"><i class="Hui-iconfont">添加视频</i></a>
                                            </td>
                                </tr>
                            <?php endforeach;?>
                        </tbody>
        ...
        <script type="text/javascript">
                                            ...
                                            function product_show(title, url, w, h){
                                                ...
                                                var w = 650;
                                                var h = 450;
                                                var url = "<?=Url::to(['video/show'])?>"+'?id='+id;
